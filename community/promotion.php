...
<div id="mainContent" class="container g<?=$gNum?> s<?=$sNum?>">
	...
	<div class="inner">
		...
		<div class="board_list">
			<table>
				...
				<tbody>
					<tr class="file">
						<td class="num">10</td>
						<td class="tal"><a href="/community/promotion_view.php">It’s the space where the title goes in.</a></td>
		...
		<div class="board_bottom">
			<a href="/community/promotion_write.php" class="btn_write">WRITE</a>
