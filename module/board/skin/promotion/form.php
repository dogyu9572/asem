        ...
        <div class="board_write bdt">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="etc_1" class="text w1" placeholder="Company Name"></td>
                </tr>
                <tr>
                    <th>Author<span>*</span></th>
                    <td><input type="text" name="name" class="text w1" placeholder="Author"></td>
                </tr>
                <tr>
                    <th>Email<span>*</span></th>
                    <td><input type="text" name="email" class="text w1" placeholder="Email"></td>
                </tr>
                <tr>
                    <th>Subject<span>*</span></th>
                    <td><input type="text" name="subject" class="text w1" placeholder="Subject"></td>
                </tr>
                <tr>
                    <th>Content<span>*</span></th>
                    <td><textarea name="contents" id="contents" cols="30" rows="10" class="text w100p" placeholder="Content"></textarea></td>
                </tr>
                <tr>
                    <th>Password<span>*</span><p>Please set a password to use when <br class="pc_vw">editing or deleting this post later.</p></th>
                    <td><input type="password" name="password" class="text w1" placeholder="Password"></td>
                </tr>
                <tr>
            ...
            <table class="terms">
                ...
                <tr>
                    <td>
                        <div class="flex">
                            <label class="check"><input type="checkbox" name="agree" value="Y"><i></i>[Required] I agree to the Privacy Policy.</label>
                            <button type="button" class="btn_write" onclick="if(validateForm(document.form1)) document.form1.submit();">WRITE</button>
                        </div>
                    </td>
                </tr>
                </tbody>
    ...
    <script>
        function validateForm(frm) {
            ...
            if (frm.email.value.trim() === "") {
                ...
                frm.email.focus();
                return false;
            } else if (!emailRegex.test(frm.email.value.trim())) {
