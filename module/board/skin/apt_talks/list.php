...
<div class="container">
	...
	<div class="inbox top_search">		
        ...
        <div class="inbox write_tbl mo_break_write">
            <div class="tit mb0">APT talks 비밀번호 설정</div>
            <div class="tbl">
                <table>
                    <tr>
                        <th>비밀번호 설정</th>
                        <td>
                            <div class="inputs">
                                <input type="text" class="w4" id="apt_password" name="apt_password" value="<?=$arrSetInfo["list"][0]['apt_password']?>">
                                <button type="button" class="btn btn_save" onclick="saveAptPassword()">저장</button>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <script>
                function saveAptPassword() {
                    var password = $("#apt_password").val();
                    if(!password) {
                        alert("비밀번호를 입력해주세요.");
                        $("#apt_password").focus();
                        return;
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/backoffice/module/admin/admin_evn.php",
                        data: {
                            evnMode: "setAptPassword",
                            apt_password: password
                        },
                        success: function(response) {
                            alert("비밀번호가 성공적으로 저장되었습니다.");
                        },
                        error: function() {
                            alert("비밀번호 저장에 실패했습니다. 다시 시도해주세요.");
                        }
                    });
                }
            </script>
