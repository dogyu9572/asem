...
?>
    <div class="inner">
        ...
        <div class="search_box">
            ...
            <div class="meet_startups">
                ...
                if($arrBoardList["list"]["total"] > 0){
                    for($i=0; $i < $arrBoardList["list"]["total"]; $i++){
                        ...
                        ?>
                        <a href="javascript:void(0);" onclick="openPop('popMeetStartups_<?=$i?>')">
                            <span class="imgfit"><img src="<?=$imgsrc[$i]?>" alt="image"></span>
                            <ul class="tag">
                                <li><?=$arrBoardList["list"][$i]['etc_7']?></li>
                                <li><?=$arrBoardList["list"][$i]['etc_8']?></li>
                            </ul>
                            <span class="name"><?=$arrBoardList["list"][$i]['subject']?></span>
                            <p><?=$arrBoardList["list"][$i]['contents']?></p>
                        </a>
                        <?php
                    }
                }
            ...
            <?php
            // 팝업들을 meet_startups 밖에 생성
            if($arrBoardList["list"]["total"] > 0){
                for($i=0; $i < $arrBoardList["list"]["total"]; $i++){
                    ?>
                    <div class="popup" id="popMeetStartups_<?=$i?>">
                        <div class="dm" onclick="closePop('popMeetStartups_<?=$i?>')"></div>
                        <div class="inbox">
                            <button type="button" class="btn_close" onclick="closePop('popMeetStartups_<?=$i?>')">닫기</button>
                            <div class="head">
                                ...
                                <div class="txt">
                                    ...
                                    <div class="contact">
                                        ...
                                        <a href="<?=$arrBoardList["list"][$i]['etc_2']?>"><img src="/pub/images/icon_contact04.svg" alt="지구본"></a>
                                        <a href="<?=$arrBoardList["list"][$i]['etc_3']?>"><img src="/pub/images/icon_contact02.svg" alt="인스타그램"></a>
                                        <a href="<?=$arrBoardList["list"][$i]['etc_4']?>"><img src="/pub/images/icon_contact05.svg" alt="in"></a>
                                        <a href="<?=$arrBoardList["list"][$i]['etc_5']?>"><img src="/pub/images/icon_contact06.svg" alt="페이스북"></a>
                                        <a href="<?=$arrBoardList["list"][$i]['etc_6']?>"><img src="/pub/images/icon_contact03.svg" alt="링크트리"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="body">
                                <?=$arrBoardList["list"][$i]['contents']?>
                            </div>
                            <div class="btns tac">
                                <a href="javascript:void(0);" onclick="closePop('popMeetStartups_<?=$i?>')">CLOSE</a>
                            </div>
                        </div>
                    </div>
                    <?php
